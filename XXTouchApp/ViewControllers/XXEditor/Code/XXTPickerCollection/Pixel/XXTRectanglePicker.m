        ...
        if (imageData) {
            ...
            if (image) {
                ...
                UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:NSLocalizedStringFromTableInBundle(@"Error", nil, [XXTPickerHelper bundle], nil)
                                                                    message:NSLocalizedStringFromTableInBundle(@"Cannot read image data, invalid image?", nil, [XXTPickerHelper bundle], nil)
                                                                   delegate:self
...
- (UIToolbar *)cropToolbar {
    if (!_cropToolbar) {
        ...
        NSBundle *frameworkBundle = [XXTPickerHelper bundle];
...
- (void)updateTipsFromSelectedStatus {
    if (!self.selectedImage) {
        [self updateSubtitle:NSLocalizedStringFromTableInBundle(@"Select an image from album.", nil, [XXTPickerHelper bundle], nil)];
    } else {
        switch ([[self class] cropViewType]) {
            case XXTPixelPickerTypeRect:
                [self updateSubtitle:NSLocalizedStringFromTableInBundle(@"Select a rectangle area by dragging its corners.", nil, [XXTPickerHelper bundle], nil)];
                break;
            case XXTPixelPickerTypePosition:
            case XXTPixelPickerTypePositionColor:
                [self updateSubtitle:NSLocalizedStringFromTableInBundle(@"Select a position by tapping on image.", nil, [XXTPickerHelper bundle], nil)];
                break;
            case XXTPixelPickerTypeColor:
                [self updateSubtitle:NSLocalizedStringFromTableInBundle(@"Select a color by tapping on image.", nil, [XXTPickerHelper bundle], nil)];
                break;
            case XXTPixelPickerTypeMultiplePositionColor:
                [self updateSubtitle:NSLocalizedStringFromTableInBundle(@"Select several positions by tapping on image.", nil, [XXTPickerHelper bundle], nil)];
                break;
        }
    }
}
...
- (void)tripleFingerTapped:(UITapGestureRecognizer *)sender {
    if (sender.state == UIGestureRecognizerStateEnded) {
        [self updateSubtitle:NSLocalizedStringFromTableInBundle(@"Triple touches to enter/exit fullscreen.", nil, [XXTPickerHelper bundle], nil)];
...
- (void)resetButtonTapped:(UIBarButtonItem *)sender {
    ...
    if ([self.cropView userHasModifiedCropArea]) {
        ...
        [self updateSubtitle:NSLocalizedStringFromTableInBundle(@"Canvas reset.", nil, [XXTPickerHelper bundle], nil)];
    }
}
...
- (void)lockButtonTapped:(id)sender {
    ...
    if (self.locked) {
        ...
        [self updateSubtitle:NSLocalizedStringFromTableInBundle(@"Canvas unlocked.", nil, [XXTPickerHelper bundle], nil)];
    } else {
        self.locked = YES;
        self.cropView.allowsOperation = NO;
        self.lockButton.selected = YES;
        [self updateSubtitle:NSLocalizedStringFromTableInBundle(@"Canvas locked, it cannot be moved or zoomed.", nil, [XXTPickerHelper bundle], nil)];
    }
}

- (void)trashButtonTapped:(id)sender {
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:NSLocalizedStringFromTableInBundle(@"Confirm", nil, [XXTPickerHelper bundle], nil)
                                                        message:NSLocalizedStringFromTableInBundle(@"Discard all changes and reset the canvas?", nil, [XXTPickerHelper bundle], nil)
                                                       delegate:self
                                              cancelButtonTitle:NSLocalizedStringFromTableInBundle(@"Cancel", nil, [XXTPickerHelper bundle], nil)
                                              otherButtonTitles:NSLocalizedStringFromTableInBundle(@"Yes", nil, [XXTPickerHelper bundle], nil), nil];
    [alertView show];
}
...
- (NSString *)title {
    switch ([[self class] cropViewType]) {
        case XXTPixelPickerTypeRect:
            return NSLocalizedStringFromTableInBundle(@"Rectangle", nil, [XXTPickerHelper bundle], nil);
        case XXTPixelPickerTypePosition:
            return NSLocalizedStringFromTableInBundle(@"Position", nil, [XXTPickerHelper bundle], nil);
        case XXTPixelPickerTypeColor:
            return NSLocalizedStringFromTableInBundle(@"Color", nil, [XXTPickerHelper bundle], nil);
        case XXTPixelPickerTypePositionColor:
            return NSLocalizedStringFromTableInBundle(@"Position & Color", nil, [XXTPickerHelper bundle], nil);
        case XXTPixelPickerTypeMultiplePositionColor:
            return NSLocalizedStringFromTableInBundle(@"Position & Color", nil, [XXTPickerHelper bundle], nil);
    }
    return @"";
...
- (void)cropView:(XXTPixelCropView *)crop shouldEnterFullscreen:(BOOL)fullscreen {
    [self updateSubtitle:NSLocalizedStringFromTableInBundle(@"Tap blank area to enter/exit fullscreen.", nil, [XXTPickerHelper bundle], nil)];
