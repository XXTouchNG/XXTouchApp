...
@implementation XXTColor

+ (XXTColor *)colorWithRed:(uint8_t)red green:(uint8_t)green blue:(uint8_t)blue alpha:(uint8_t)alpha
{
    return [[[XXTColor alloc] autorelease] initWithRed:red green:green blue:blue alpha:alpha];
}

+ (XXTColor *)colorWithUIColor:(UIColor *)uicolor
{
    return [[[XXTColor alloc] autorelease] initWithUIColor:uicolor];
}

+ (XXTColor *)colorWithColor:(uint32_t)color
{
    return [[[XXTColor alloc] autorelease] initWithColor:color];
}

+ (XXTColor *)colorWithXXTColor:(XXTColor *)xxtcolor
{
    return [[[XXTColor alloc] autorelease] initWithXXTColor:xxtcolor];
}
...
- (XXTColor *)initWithUIColor:(UIColor *)uicolor
{
    self = [self init];
...
- (XXTColor *)initWithRed:(uint8_t)red green:(uint8_t)green blue:(uint8_t)blue alpha:(uint8_t)alpha
{
    self = [self init];
...
- (XXTColor *)initWithColor:(uint32_t)color
{
    SZ_COLOR c;
    c.the_color = color;
...
- (XXTColor *)initWithXXTColor:(XXTColor *)xxtcolor
{
