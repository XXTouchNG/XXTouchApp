...
- (XXTColor *)getColorOfPoint:(CGPoint)point
{
    ...
    return [XXTColor colorWithRed:color_of_point.red green:color_of_point.green blue:color_of_point.blue alpha:color_of_point.alpha];
}
...
- (NSString *)getColorHexOfPoint:(CGPoint)point
{
    SZ_COLOR color_of_point;
    get_color_in_pixels_image_safe(_pixel_image, point.x, point.y, &color_of_point);
    return [[XXTColor colorWithRed:color_of_point.red green:color_of_point.green blue:color_of_point.blue alpha:color_of_point.alpha] getColorHex];
}
