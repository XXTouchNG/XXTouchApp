...
#import "XXImagePickerAlbumCell.h"
...
- (void)viewDidLoad
{
    ...
    UINib *nib = [UINib nibWithNibName:@"XXImagePickerPhotoCell" bundle:nil];
    [_cvPhotoList registerNib:nib forCellWithReuseIdentifier:@"XXImagePickerPhotoCell"];
...
- (void)initBottomMenu
{
    ...
    _ivLine1.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"picker-line"]];
    _ivLine2.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"picker-line"]];
...
{
    XXImagePickerAlbumCell *cell = (XXImagePickerAlbumCell*)[tableView dequeueReusableCellWithIdentifier:@"XXImagePickerAlbumCell"];
    
    if (cell == nil)
    {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"XXImagePickerAlbumCell" owner:nil options:nil] lastObject];
    }
...
{
    XXImagePickerPhotoCell *cell = (XXImagePickerPhotoCell *)[_cvPhotoList dequeueReusableCellWithReuseIdentifier:@"XXImagePickerPhotoCell" forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
		XXImagePickerPhotoCell *cell = (XXImagePickerPhotoCell *)[collectionView cellForItemAtIndexPath:indexPath];
