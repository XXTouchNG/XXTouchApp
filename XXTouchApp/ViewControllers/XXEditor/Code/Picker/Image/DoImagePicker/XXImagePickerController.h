...
#define DO_MENU_BACK_COLOR          DO_RGBA(26, 161, 230, 0.98)
#define DO_SIDE_BUTTON_COLOR        DO_RGBA(26, 161, 230, 0.9)

#define DO_ALBUM_NAME_TEXT_COLOR    DO_RGB(26, 161, 230)
...
@interface XXImagePickerController : UIViewController
