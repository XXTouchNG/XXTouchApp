...
- (void)expandBarTapped:(UITapGestureRecognizer *)gestureRecognizer {
    if (gestureRecognizer.state == UIGestureRecognizerStateEnded) {
        if ([self.topViewController isKindOfClass:[XXPickerBaseViewController class]]) {
            ...
            UINavigationController *navController = [[UIStoryboard storyboardWithName:@"CodePreview" bundle:[NSBundle mainBundle]] instantiateViewControllerWithIdentifier:kXXCodeBlockExpandViewControllerStoryboardID];
