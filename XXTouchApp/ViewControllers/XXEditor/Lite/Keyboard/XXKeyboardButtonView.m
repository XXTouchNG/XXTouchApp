...
@interface XXKeyboardButtonView ()
@property (nonatomic, weak) XXKeyboardButton *button;
@property (nonatomic, assign) XXKeyboardButtonPosition expandedPosition;
@end

@implementation XXKeyboardButtonView

#pragma mark - UIView

- (instancetype)initWithKeyboardButton:(XXKeyboardButton *)button
{
    ...
    if (self) {
        ...
        if (button.position != XXKeyboardButtonPositionInner) {
            ...
            _expandedPosition = (leftPadding > rightPadding ? XXKeyboardButtonPositionLeft : XXKeyboardButtonPositionRight);
        }
    }
...
- (UIBezierPath *)inputViewPath
{
    ...
    switch (self.button.position) {
        case XXKeyboardButtonPositionInner:
        {
        ...
        case XXKeyboardButtonPositionLeft:
        {
            [path rightArc:majorRadius turn:90]; // #1
            [path forward:upperWidth - 2 * majorRadius]; // #2 top
            [path rightArc:majorRadius turn:90]; // #3
        ...
        case XXKeyboardButtonPositionRight:
        {
            [path rightArc:majorRadius turn:90]; // #1
            [path forward:upperWidth - 2 * majorRadius]; // #2 top
            [path rightArc:majorRadius turn:90]; // #3
