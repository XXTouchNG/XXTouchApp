...
- (void)saveImage:(UIImage *)image
    ...
    if (status != PHAuthorizationStatusAuthorized) {
        if (failure) {
            NSDictionary *userInfo = [NSDictionary dictionaryWithObject:NSLocalizedString(@"Permission Denied", nil) forKey:NSLocalizedDescriptionKey];
    ...
    if (image == nil) {
        if (failure) {
            NSMutableDictionary *userInfo = [NSMutableDictionary dictionaryWithObject:NSLocalizedString(@"Image cannot be empty", nil) forKey:NSLocalizedFailureReasonErrorKey];
    ...
    [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
        ...
        if (error) {
            if (failure) {
                NSDictionary *userInfo = [NSDictionary dictionaryWithObject:NSLocalizedString(@"Image cannot be saved to system album", nil) forKey:NSLocalizedDescriptionKey];
            ...
            [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
                ...
                if (error) {
                    if (failure) {
                        NSDictionary *userInfo = [NSDictionary dictionaryWithObject:NSLocalizedString(@"Image cannot be saved to custom album", nil) forKey:NSLocalizedDescriptionKey];
