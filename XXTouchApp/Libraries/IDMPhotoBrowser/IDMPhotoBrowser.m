...
@synthesize leftArrowImage = _leftArrowImage, rightArrowImage = _rightArrowImage;
...
//        _usePopAnimation = NO;
        ...
        _leftArrowImage = _rightArrowImage = nil;
...
- (void)viewDidLoad {
    ...
    [UIImage imageNamed:@"IDMPhotoBrowser_arrowLeft"]          : _leftArrowImage;

    UIImage *rightButtonImage = (_rightArrowImage == nil) ?
    [UIImage imageNamed:@"IDMPhotoBrowser_arrowRight"]         : _rightArrowImage;
