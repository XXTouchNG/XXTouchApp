...
- (NSString *)ipAddressWithIfaName:(NSString *)name family:(sa_family_t)f {
...
- (NSString *)ipAddressWIFI {
    return [self ipAddressWithIfaName:@"en0" family:AF_INET];
}

- (NSString *)ipAddressCell {
    return [self ipAddressWithIfaName:@"pdp_ip0" family:AF_INET];
}
